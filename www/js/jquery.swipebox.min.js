	...
	c.swipebox = function(e, f) {
		...
		j.settings = {}, c.swipebox.close = function() {
			...
			openSlide: function(b) {
				c("html").addClass("swipebox-html"), $('.scroll-content.ionic-scroll.has-header, .bar.no-border.blue').addClass('blur_small'), o ? (c("html").addClass("swipebox-touch"), j.settings.hideCloseButtonOnMobile && c("html").addClass("swipebox-no-close-button")) : c("html").addClass("swipebox-no-touch"), c(a).trigger("resize"), this.setSlide(b, !0)
			},
