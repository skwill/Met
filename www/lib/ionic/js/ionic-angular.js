 ...
 */
     ...
     */
    IonicModule
        .factory('$ionicPosition', ['$document', '$window',
     ...
     */
    IonicModule
        .factory('$ionicViewService', ['$ionicHistory', '$log',
    ...
    IonicModule
        .directive('ionCheckbox', ['$ionicConfig',
     ...
     */
    IonicModule.directive('exposeAsideWhen', ['$window',
        function($window) {
            return {
                restrict: 'A',
     ...
     */
    IonicModule
        .directive('ionReorderButton', ['$parse',
            function($parse) {
                return {
                    restrict: 'E',
                    require: ['^ionItem', '^?ionList'],
     ...
     */
    IonicModule
        .directive('menuClose', ['$ionicHistory', '$timeout',
     ...
     */
    IonicModule
        .directive('ionNavBackButton', ['$ionicConfig', '$document',
     ...
     */
    IonicModule
        .directive('ionNavButtons', ['$document',
            function($document) {
                return {
                    require: '^ionNavBar',
                    restrict: 'E',
     ...
     */
    IonicModule
        .directive('navDirection', ['$ionicViewSwitcher',
     ...
     */
    IonicModule
        .directive('ionNavTitle', ['$document',
            function($document) {
                return {
                    require: '^ionNavBar',
                    restrict: 'E',
     ...
     */
    IonicModule
        .directive('navTransition', ['$ionicViewSwitcher',
            function($ionicViewSwitcher) {
                return {
                    restrict: 'A',
                    priority: 1000,
     ...
     *
     */
    .directive('ionSideMenus', ['$ionicBody',
        function($ionicBody) {
            return {
                restrict: 'ECA',
                controller: '$ionicSideMenus',
